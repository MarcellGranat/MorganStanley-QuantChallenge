.read(distance_df)
.read(daily_weather_df, prediction_targets_df, minnesota_county_location_df, minnesota_production_df, minnesota_station_location_df)
...
minnesota_production_df |> 
  ...
  select(- commodity, - crop, - production, - acres)
